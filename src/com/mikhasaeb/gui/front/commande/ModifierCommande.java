...
public class ModifierCommande extends Form {
    ...
    private void addGUIs() {
        ...
        prixTotaleTF.setText(String.valueOf(currentCommande.getPrixTotale()));
        produitsTF.setText(currentCommande.getProduits());
        adresseTF.setText(currentCommande.getAdresse());

        userPC.getPicker().setSelectedString(currentCommande.getUser().getEmail());
        selectedUser = currentCommande.getUser();
